...
public class LoginServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request,
		...
		// 1. 讀取使用者輸入資料
		String userId = request.getParameter("indid");
		String password = request.getParameter("indpassword");
		...
		if (rm != null) {   // rm存放瀏覽器送來之RememberMe的選項
			...
			String encodePassword = GlobalService.encryptString(password);
			String captionPassword = URLEncoder.encode(
					GlobalService.encryptString("password"), "UTF8");
