...
public class sql_Common {
	...
	static String CREATE_FUNCTION_INSERT_DEAL = "CREATE FUNCTION insert_deal(USER_goodsno int,USER_INDID varchar(50),USER_QTY int,USER_ENDSHIPWAY int,"
			+ "USER_DEALNO VARCHAR(200),USER_IMAGE MEDIUMBLOB,USER_FILENAME VARCHAR(20))RETURNS VARCHAR(10)BEGIN DECLARE function_qty INT DEFAULT 0;"
			...
			+ "INSERT INTO DEAL VALUE(NULL,NULL,USER_INDID,function_indid,0,USER_ENDSHIPWAY,USER_QTY,NULL,NULL,USER_DEALNO,USER_IMAGE,USER_FILENAME,function_goodsname,"
			...
			+ "ELSE INSERT INTO DEAL VALUE(NULL,NULL,function_indid,USER_INDID,0,USER_ENDSHIPWAY,USER_QTY,NULL,NULL,USER_DEALNO,USER_IMAGE,USER_FILENAME,function_goodsname,"
			+ "function_goodsimage,CONCAT(USER_goodsno,CONCAT('_',UNIX_TIMESTAMP(NOW()))),function_goodstypes,function_goodsloc,function_goodsnote,function_goodsstatus);"
			+ "END IF;UPDATE goods SET qty=(qty-USER_QTY) WHERE GOODSNO=USER_goodsno;SET result = 'TRUE';ELSE SET result = 'FLASE';END IF;RETURN result;END;";
	...
	public static String CALL_FUNCTION_INSERT_DEAL = "{? = CALL insert_deal(?,?,?,?,?,?,?)}";
