...
public class GlobalService {
	...
	// public static final String DB_URLMySQL = "jdbc:mysql://" +
	// GlobalService.host + "/jspdb?useUnicode=yes&characterEncoding=utf8" ;
	public static final String DB_URLMySQL = "jdbc:mysql://" + GlobalService.host
			+ "/weshare?useUnicode=yes&characterEncoding=utf8";
	public static final String KEY = "KittySnoopyMicky"; // 16, 24, 32
	// Drop your Authorization
	// https://myaccount.google.com/permissions?hl=zh_TW&pli=1
	// get google api kry
	// https://console.developers.google.com/apis
	static final String GOOGLE_CLIENT_ID = "961915936370-5g9vhfth0ki31bb4dt9g22dfgeoikg53.apps.googleusercontent.com";
			...
			for (Part part : parts) {
				...
				if (contentType != null) { // 表示該part為檔案
					...
					if (filename != null && filename.trim().length() > 0) {
						part.write(filename);
						System.out.println("part.getClass().getName()==>" + part.getClass().getName());
