...
@WebServlet("/web/_05_deal/controller/agreenByKey")
public class agreenByKeyServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	public agreenByKeyServlet() {
		super();
	}
	...
	public void do_First(HttpServletRequest request, HttpServletResponse response)
		...
		if (Ans.equals("TRUE")) {
			...
			String SQLAns = new DealDAO().agreen_DEAL(key, INDID);
