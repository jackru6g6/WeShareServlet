...
<body>
						...
						<div id="blockWTransOption" class="col-xs-12 col-sm-12 col-md-12 col-lg-10 col-lg-offset-1">
							<ul type="none" class="row">
								...
								<li class="col-xs-5 col-sm-5 col-md-5 col-lg-4 col-lg-push-3">
									<a id="aSendTrans" data-toggle="modal" data-target="#transMsg" class="btn btn-default wTransOption">確定送出</a>
								</li>
							</ul>
						</div>
					</div>
	...
	<script src="${pageContext.request.contextPath}/dist/js/wishTrans.js"></script>
