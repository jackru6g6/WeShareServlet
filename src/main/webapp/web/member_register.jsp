...
<%-- 									<input type="email" name="indemail" value="${param.indemail}" id="" class="form-control" placeholder="example@email.com"> --%>
					...
					<div class="form-group register_form_group ind">
						...
						<div class="col-sm-9">
							<input type="text" name="ind_address" value="" id="" class="form-control register_form_input">
						</div>
					</div>
					...
					<div class="form-group register_form_group org">
						...
						<div class="col-sm-9">
							<input  type="text" name="leader" value="" id="" class="form-control register_form_input">
						</div>
					</div>
					...
					<div class="form-group register_form_group org">
						...
						<div class="col-sm-9">
							<input type="text" name="register_no" value="" id="" class="form-control register_form_input">
						</div>
					</div>
					...
					<div class="form-group register_form_group org">
						...
						<div class="col-sm-9">
							<input type="text" name="raise_no" value="" id="" class="form-control register_form_input">
						</div>
					</div>
					...
					<div class="form-group  register_form_group org">
						...
						<div class="col-sm-9">
							<textarea name="intro" value="" id="" class="form-control register_form_input" rows="5" Wrap="physical"></textarea>
						</div>
					</div>
